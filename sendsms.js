...
try{
		...
		var body = 	{
			...
			request(options,  (err, response, body)=>{
				if ( (typeof err=='null') || (typeof response == 'undefined') ) {
					...
					console.log('answer error!');ClaraIASpeech("un problème est survenu")
		...
		ClaraIASpeech("Message à " + data.destinataire + " envoyé. "+"|en esperant que la personne le lise|si son portable est allumé|la personne va peut etre répondre")				
...
var reg="/"+data.pharsesms+"(.+)/i" ; var rgxp = eval(reg) ; var temp = ClaraIA.reco.match(rgxp) ; console.log(temp)
